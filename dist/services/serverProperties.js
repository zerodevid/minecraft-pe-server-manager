...
exports.getSettingsSections = getSettingsSections;
...
function readProperties() {
    ...
    const raw = fs_1.default.readFileSync(SERVER_PROPERTIES, 'utf-8');
...
function updateSettings(payload = {}) {
    ...
    fs_1.default.writeFileSync(SERVER_PROPERTIES, content);
